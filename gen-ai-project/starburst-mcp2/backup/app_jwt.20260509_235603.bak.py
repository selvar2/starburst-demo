# ============================================================================
# BACKUP: app_jwt.py
# Timestamp:  2026-05-09T18:26:03Z (TS=20260509_235603)
# Source:     gen-ai-project/starburst-mcp2/app_jwt.py
# Branch:     dev3 @ commit db6bb19
# Why:        Adding business-user NL UPDATE grammar — parallel to the
#             NL INSERT pattern. Recognizes phrasings like:
#               'In catalog X, schema Y, table Z, update the row where ... and set ...'
#               'Change <col> to <val> in catalog X, schema Y, table Z for the row where ...'
#               'Update X.Y.Z and set <col> = <val> where ...'
# Before:     /api/chat handled UPDATE only as raw SQL or via the simple
#             'update <tbl> set <cols> [where <cond>]' regex. Verbose
#             business phrasings were not recognized; existing pattern
#             also allowed UPDATE without WHERE (silently affecting all rows).
...
#             clause (rejected if missing). Existing simple UPDATE pattern
#             retained for technical-user SQL passthrough.
# Restore:    cp 'gen-ai-project/starburst-mcp2/backup/app_jwt.20260509_235603.bak.py' gen-ai-project/starburst-mcp2/app_jwt.py
# ============================================================================
