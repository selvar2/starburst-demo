# ============================================================================
# BACKUP: app_jwt.py
# Timestamp:  2026-05-10T05:47:19Z (TS=20260510_111719)
# Source:     gen-ai-project/starburst-mcp2/app_jwt.py
# Branch:     dev6-cp-dev3 @ commit bc67ed4
# Why:        Adding business-user NL TRUNCATE grammar — mirrors
#             INSERT/UPDATE/DELETE patterns. Recognizes 'clear all rows from',
#             'empty the table', 'remove all data from', and
...
# Restore:    cp 'gen-ai-project/starburst-mcp2/backup/app_jwt.20260510_111719.bak.py' gen-ai-project/starburst-mcp2/app_jwt.py
# ============================================================================
