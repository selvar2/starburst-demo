# ============================================================================
# BACKUP: app_jwt.py
# Timestamp:  2026-05-09T17:50:40Z (TS=20260509_232040)
# Source:     gen-ai-project/starburst-mcp2/app_jwt.py
# Branch:     dev3 @ commit db6bb19
# Why:        Adding business-user NL INSERT grammar (verbose form with
#             explicit catalog/schema/table phrases and 'with col val' pairs),
#             on top of the existing developer-SQL INSERT and the simple
#             'insert into <tbl>' NL pattern.
# Before:     /api/chat handled INSERT only as raw SQL or as a single regex
#             that auto-qualified bare names. Phrasing like 'add a new row
#             into catalog X, schema Y, table Z with id 1, name foo' was
#             not recognized.
# After:      New _nl_insert_to_sql() parser handles three forms — dotted,
#             verbose ('catalog X, schema Y, table Z'), and embedded-FQ —
#             with strict identifier + value rendering. Existing patterns
#             unchanged.
# Restore:    cp gen-ai-project/starburst-mcp2/backup/app_jwt.20260509_232040.bak.py gen-ai-project/starburst-mcp2/app_jwt.py
# ============================================================================
