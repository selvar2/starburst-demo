# ============================================================================
# BACKUP: app_jwt.py
# Timestamp:  2026-05-10T05:30:01Z (TS=20260510_110001)
# Source:     gen-ai-project/starburst-mcp2/app_jwt.py
# Branch:     dev6-cp-dev3 @ commit bc67ed4
# Why:        Adding business-user NL DELETE grammar — mirrors NL INSERT/UPDATE.
#             Recognizes 'remove the record/row from ...', 'delete the row where',
#             'delete rows from <FQ> where ...', '^in catalog/schema ... delete|remove'.
...
# Restore:    cp 'gen-ai-project/starburst-mcp2/backup/app_jwt.20260510_110001.bak.py' gen-ai-project/starburst-mcp2/app_jwt.py
# ============================================================================
